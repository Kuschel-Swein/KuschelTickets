...
if(STEP == 2 && isset($_POST['submit'])) {
    ...
    if($pdoerror == "") {
        ...
        $statements = [
            ...
            "CREATE TABLE `kuscheltickets1_faq` (
            ...
            "CREATE TABLE `kuscheltickets1_groups` (
                `groupID` int(11) NOT NULL,
                `name` varchar(255) NOT NULL,
                `badge` text NOT NULL,
                `system` int(11) DEFAULT NULL
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8;",
            "CREATE TABLE `kuscheltickets1_group_permissions` (
                `permissionID` int(11) NOT NULL,
                `groupID` int(11) NOT NULL,
                `name` text NOT NULL,
                `value` int(11) NOT NULL
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8;",
            "CREATE TABLE `kuscheltickets1_menu` (
            ...
            "CREATE TABLE `kuscheltickets1_pages` (
            ...
            "CREATE TABLE `kuscheltickets1_supportchat` (
            ...
            "CREATE TABLE `kuscheltickets1_supportchat_messages` (
            ...
            "CREATE TABLE `kuscheltickets1_tickets` (
            ...
            "CREATE TABLE `kuscheltickets1_ticket_answers` (
        ...
        $statements = [
            ...
            "ALTER TABLE `kuscheltickets1_notifications` ADD PRIMARY KEY (`notificationID`), ADD KEY `userID` (`userID`);",
            "ALTER TABLE `kuscheltickets1_pages` ADD PRIMARY KEY (`pageID`);",
            "ALTER TABLE `kuscheltickets1_supportchat` ADD PRIMARY KEY (`chatID`), ADD KEY `creator` (`creator`), ADD KEY `user` (`user`);",
        ...
        $statements = [
            ...
            "ALTER TABLE `kuscheltickets1_notifications` MODIFY `notificationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;",
            "ALTER TABLE `kuscheltickets1_pages` MODIFY `pageID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;",
            "ALTER TABLE `kuscheltickets1_supportchat` MODIFY `chatID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;",
        ...
        $statements = [
            ...
            "ALTER TABLE `kuscheltickets1_supportchat` ADD CONSTRAINT `kuscheltickets1_supportchat_ibfk_1` FOREIGN KEY (`creator`) REFERENCES `kuscheltickets1_accounts` (`userID`) ON DELETE CASCADE, ADD CONSTRAINT `kuscheltickets1_supportchat_ibfk_2` FOREIGN KEY (`user`) REFERENCES `kuscheltickets1_accounts` (`userID`) ON DELETE CASCADE;",
...
<html>
    ...
    <script>
        ...
        <blockquote>
                ...
                <br>
                Copyright (c) <?php date("Y"); ?>, Kuschel-Swein<br>
        ...
        <p></p>
        <p><i>Hinweis:</i> <a href="requirements.php" target="_blank">hier</a> kannst du nachsehen ob dein Webserver alle Anforderungen unterstützt.</p>
        <p>
